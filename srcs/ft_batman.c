...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/06 23:23:00 by badhont           #+#    #+#             */
/*   Updated: 2019/03/06 23:24:43 by badhont          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

int		ft_cp_burning_a(t_thrd *thrd, t_cplx c, t_cplx z)
{
	double	sqi;
	double	sqr;
	int		i;
...
int		ft_cp_batman(t_thrd *thrd, t_cplx c, t_cplx z)
{
	double	sqi;
	double	sqr;
	int		i;
